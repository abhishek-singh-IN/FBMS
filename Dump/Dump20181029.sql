CREATE DATABASE  IF NOT EXISTS `practise` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `practise`;
...
CREATE TABLE `coach` (
  ...
  KEY `Team_id` (`Team_id`),
  KEY `Coach_Name` (`First_Name`,`Last_Name`),
  CONSTRAINT `coach_ibfk_1` FOREIGN KEY (`Team_id`) REFERENCES `teams` (`team_id`)
...
INSERT INTO `coach` VALUES ('PLC001','Unai ','Emery','Spain',2018,1),('PLC002','Eddie ','Howe','England',2012,2),('PLC003','Chris ','Hughton','Ireland',2014,3),('PLC004','Sean ','Dyche','England',2012,4),('PLC005','Neil ','Warnock','England',2016,5),('PLC006','Maurizio ','Sarri','Italy',2018,6),('PLC007','Roy ','Hodgson','England',2017,7),('PLC008','Marco ','Silva','Portugal',2018,8),('PLC009','Slavisa ','Jokanovic','Serbia',2015,9),('PLC010','David ','David Wagner','United States',2015,10);
...
INSERT INTO `own` VALUES (1,'Arsenal Holdings'),(1,'Stan Kroenke '),(2,'Maxim Demin'),(3,'Tony Bloom'),(4,'Alex Hales'),(4,'Mike Garlick'),(5,'Vincent Tan'),(6,'Roman Abramovich'),(7,'Sheikh Bakr'),(7,'Steve Parish'),(7,'Willian Stan'),(8,'Farhad Moshiri'),(9,'Shad Khan'),(10,'Dean Hoyle');
...
INSERT INTO `teams` VALUES (1,'Arsenal','London'),(2,'Bournemouth','Bournemouth'),(3,'Brighton & Hove Albion','Brighton'),(4,'Burnley','Burnley'),(5,'Cardiff City','Cardiff'),(6,'Chelsea','London'),(7,'Crystal Palace','London'),(8,'Everton','Liverpool'),(9,'Fulham','London'),(10,'Huddersfield Town','Huddersfield');
...
--
-- Dumping events for database 'practise'
--
...
-- Dump completed on 2018-10-29 14:46:59
